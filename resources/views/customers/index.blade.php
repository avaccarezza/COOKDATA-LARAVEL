...
@section('content')
    ...
    <a class="btn btn-success mb-3 right" href="{{ route('customers.create') }}">Añadir</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                                ...
                                <a class="btn btn-primary"s href="{{ route('customers.show', ['customer' => $customer->id]) }}">
                            ...
                            {{-- <a class="btn btn-link" href="{{ route('customers.show', ['customer' => $customer->title]) }}">Show</a> --}}    
                        </td>
                    </tr>
                    @endforeach
                </tbody>
