                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-dark" href="{{ route('users.edit', ['user' => $user->id]) }}" title="Editar usuario">
                            ...
                            <form method="POST" class="d-inline" action="{{ route('users.destroy', ['user' => $user->id]) }}">
                                <button type="submit" class="btn btn-dark" title="Eliminar usuario">
                                @csrf
                                @method('DELETE')
                            ...
                            <a class="btn btn-dark" href="{{ route('customers_area.index') }}" title="Ir a area de clientes">
