...
<nav class="navbar navbar-light bg-light justify-content-between">
    <a class="btn btn-warning mb-3 right" href="{{ route('register')}}">Añadir</a>
            ...
            <tbody>    
                ...
                <tr>
                    ...
                    <td class="table-warning">
                       ...
                       {{-- <a class="btn btn-warning" href="{{ route('customers_area.show',  $customer->customer )}}" title="Ir a area de clientes">
